...
public class FieldThermoGrid : MonoBehaviour
{
    ...
    private float adjutableFieldTemp;
    ...
    internal void SetParameters()
    {
        ...
        adjutableFieldTemp = m_ResetParams.GetWithDefault("fieldDefaultTemp", fieldDefaultTemp);
    ...
    public float GetFieldDefaultTemp()
    {
        Debug.Log("Default FieldThermoGrid: " + fieldDefaultTemp);
