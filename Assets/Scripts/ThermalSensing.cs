...
public class ThermalSensing : MonoBehaviour
{
        ...
        {
                // nightAreaTemp = (float)area.GetComponent<AreaTempSmoothing>().GetAreaTemp(x + 50, z + 50) + sun.GetComponent<DayAndNight>().nightTemperatureVariance;
                nightAreaTemp = (float)area.GetComponent<FieldThermoGrid>().GetAreaTemp(x, z) + sun.GetComponent<DayAndNight>().nightTemperatureVariance;
        ...
        {
                // dayAreaTemp = (float)area.GetComponent<AreaTempSmoothing>().GetAreaTemp(x + 50, z + 50) + sun.GetComponent<DayAndNight>().dayTemperatureVariance;
                dayAreaTemp = (float)area.GetComponent<FieldThermoGrid>().GetAreaTemp(x, z) + sun.GetComponent<DayAndNight>().dayTemperatureVariance;
                return dayAreaTemp;
        }
