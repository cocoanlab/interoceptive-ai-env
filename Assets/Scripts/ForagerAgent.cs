...
public class ForagerAgent : Agent
{
    ...
    //public int numHungerResourceObj = (int)Academy.Instance.EnvironmentParameters.GetWithDefault("numresources", 400.0f);
    //public int numThirstResourceObj = (int)Academy.Instance.EnvironmentParameters.GetWithDefault("numresources", 400.0f);
